  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-primary text-white hover:bg-primary/90 px-5 py-3 rounded-full shadow-lg text-sm font-medium transition-colors z-40"
      >
        <Plus size={18} />
        Novo lançamento
      </button>
